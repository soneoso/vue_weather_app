<template>
    <div class="flex flex-col flex-1 items-center">
        <!-- Banner -->
        <div v-if="route.query.preview" class="text-black p-4 backdrop-blur-sm bg-white/30 shadow-xl w-full text-center">
        ...
        <div class="flex flex-col items-center text-black py-12">
            ...
            `http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}@2x.png`" alt="">
        </div>
        ...
        <div class="max-w-screen-md w-full py-12">
            <div class="mx-8 text-black">
                <h2 class="mb-4">Hourly Weather Hourly weather</h2>
...
const getWeatherData = async () => {
    try {
        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&exclude={part}&appid=3529ca4a4920e13f02e9ef7cbe62d561&units=imperial`);
